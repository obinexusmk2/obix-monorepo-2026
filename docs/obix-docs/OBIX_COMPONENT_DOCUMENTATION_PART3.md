...
```typescript
import { createCard, createImage, createButton, createRating } from 'obix-component-runtime';
...
```typescript
import { createModal, createButton } from 'obix-component-runtime';
...
```typescript
import { createForm, createInput, createAlert } from 'obix-component-runtime';
...
- [GitHub: obix](https://github.com/obinexusmk2/obix)
