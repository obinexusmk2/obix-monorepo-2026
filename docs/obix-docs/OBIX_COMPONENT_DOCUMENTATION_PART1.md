...
```bash
npm install obix-component-runtime/primitives
npm install obix-component-runtime/forms
npm install obix-component-runtime/navigation
npm install obix-component-runtime/overlays
npm install obix-component-runtime/feedback
npm install obix-component-runtime/controls
npm install obix-component-runtime/data
npm install obix-component-runtime/search
```
...
```typescript
import 'obix-component-runtime/styles/scss';
```

### Step 3: Verify Installation

```bash
npm list obix-component-runtime
```

Expected output: `obix-component-runtime@0.1.0`
...
```typescript
import { createButton, createInput, createCard } from 'obix-component-runtime';
...
/** @jsx h */
/** @jsxFrag Fragment */
import { h, Fragment } from 'obix-component-runtime/jsx-runtime';
import { createButton, createInput, createForm } from 'obix-component-runtime';
...
```typescript
// Express.js example
import { createAlert, createModal, createTable } from 'obix-component-runtime';
...
```typescript
import { validateFudCompliance, applyAllFudPolicies } from 'obix-component-runtime';
...
```typescript
import 'obix-component-runtime/styles'; // Includes jfix
...
For managed lifecycle tracking, use `obix-sdk-core`:
...
```typescript
import { ObixRuntime } from 'obix-sdk-core';
